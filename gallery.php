                    ...
                    <div class="col-12 col-lg-3">
                        <div class="row">
                            <div class="col-12 mt-4">
                                ...
                                <h1 class="text-center fs-4">Horton Plains</h1>
                                <h1 class="text-center fs-4">Temple of the tooth</h1>
                                <h1 class="text-center fs-4">Unawatuna</h1>
                                <h1 class="text-center fs-4">Yala National Park</h1>
                                <h1 class="text-center fs-4">Amalfi</h1>
                                <h1 class="text-center fs-4">Fiordland</h1>
                                <h1 class="text-center fs-4">Krabi</h1>     
